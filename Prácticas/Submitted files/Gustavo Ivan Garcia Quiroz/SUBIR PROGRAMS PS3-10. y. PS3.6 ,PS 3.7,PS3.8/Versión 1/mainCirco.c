...
void leerVentas(){
	 ...
	 while( loc!=0 && boletos!=0 ){
		...
		switch(loc){
			...
			printf("\n Venta hecha zona 1 $%lf x %d boletos total = $%lf",l1,boletos, l1*boletos);
					...
					break;				
			case 2: 
			printf("\n Venta hecha zona 2 $%lf x %d boletos total = $%lf",l2,boletos, l2*boletos);
                    bl2+=boletos;
                    break;
			case 3: 
			printf("\n Venta hecha zona 1 $%lf x %d boletos total = $%lf",l3,boletos, l3*boletos);
                    bl3+=boletos;
                    break;
			case 4: 
			printf("\n Venta hecha zona 1 $%lf x %d boletos total = $%lf",l4,boletos, l4*boletos);
                    bl4+=boletos;
                    break;
			case 5: 
			printf("\n Venta hecha zona 1 $%lf x %d boletos total = $%lf",l5,boletos, l5*boletos);
                    bl5+=boletos;
                    break;
			case 6: 
			printf("\n Venta hecha zona 1 $%lf x %d boletos total = $%lf",l6,boletos, l6*boletos);
                    bl6+=boletos;
			        break;
			default: printf("\n\a Zona inexistente");
		}
	...
	printf("\n Boletos vendidos por localidad: bl2=%d",bl1);
	printf("\n Boletos vendidos por localidad: bl3=%d",bl1);
	printf("\n Boletos vendidos por localidad: bl4=%d",bl1);
	printf("\n Boletos vendidos por localidad: bl5=%d",bl1);
	printf("\n Boletos vendidos por localidad: bl6=%d",bl1);
}

int main( int x ) {
	printf(" \t\t -------Programa 3.10------- \n\n ");
